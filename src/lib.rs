...
//! ### Viterbi only
//!
//! [`fec::ViterbiOnlyFec`] is a first-class [`ErrorCorrection`] strategy — inject
//! it directly for AEAD + Viterbi (no interleaver or Reed-Solomon). It corrects
//! random bit errors (Viterbi coding gain) without RS's burst correction or the
//! ≈ 1.14× RS expansion:
//!
//! ```
//! use cryptovault::CryptoVault;
